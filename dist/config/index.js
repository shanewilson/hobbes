...
config.set('fdt_modules', _path2.default.resolve(_path2.default.join(__dirname, '..', 'node_modules')));
// ------------------------------------
// User Configuration
// ------------------------------------
...
config.set('dir_src', _path2.default.join(config.get('path_project'), 'src'));
config.set('dir_dist', _path2.default.join(config.get('path_project'), 'dist'));
